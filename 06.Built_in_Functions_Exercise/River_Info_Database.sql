...
VALUES
	...
	('BL', 'BLM', 'Saint BarthÃ©lemy', 'EUR', 'NA', 8450, 21, 'Gustavia'),
	...
	('BR', NULL, 'Brazil', 'BRL', 'SA', 201103330, 8511965, 'BrasÃ­lia'),
	...
	('CM', 'CMR', 'Cameroon', 'XAF', 'AF', 19294149, 475440, 'YaoundÃ©'),
	('CN', 'CHN', 'China', 'CNY', 'AS', 1330044000, 9596960, 'Beijing'),
	('CO', NULL, 'Colombia', 'COP', 'SA', 47790000, 1138910, 'BogotÃ¡'),
	('CR', 'CRI', 'Costa Rica', 'CRC', 'NA', 4516220, 51100, 'San JosÃ©'),
	...
	('EH', 'ESH', 'Western Sahara', 'MAD', 'AF', 273008, 266000, 'El AaiÃºn'),
	...
	('FO', 'FRO', 'Faroe Islands', 'DKK', 'EU', 48228, 1399, 'TÃ³rshavn'),
	...
	('GU', 'GUM', 'Guam', 'USD', 'OC', 159358, 549, 'HagÃ¥tÃ±a'),
	...
	('MV', 'MDV', 'Maldives', 'MVR', 'AS', 395650, 300, 'MalÃ©'),
	...
	('PY', 'PRY', 'Paraguay', 'PYG', 'SA', 6375830, 406750, 'AsunciÃ³n'),
	('QA', NULL, 'Qatar', 'QAR', 'AS', 840926, 11437, 'Doha'),
	('RE', 'REU', 'RÃ©union', 'EUR', 'AF', 776948, 2517, 'Saint-Denis'),
	...
	('ST', 'STP', 'SÃ£o TomÃ© and PrÃ­ncipe', 'STD', 'AF', 175808, 1001, 'SÃ£o TomÃ©'),
	...
	('TF', 'ATF', 'French Southern Territories', 'EUR', 'AN', 140, 7829, 'Port-aux-FranÃ§ais'),
	('TG', 'TGO', 'Togo', 'XOF', 'AF', 6587239, 56785, 'LomÃ©'),
...
VALUES
	...
	('ParanÃ¡', 4880, 2582672, 18000, 'RÃ­o de la Plata'),
	...
	('PurÃºs', 3211, 63166, 8400, 'Amazon'),
	('Yukon', 3185, 850000, 6210, 'Bering Sea'),
	('Indus', 3180, 960000, 7160, 'Arabian Sea'),
	('SÃ£o Francisco', 3180, 610000, 3300, 'Atlantic Ocean'),
